...
function complex(elem: HTMLElement | null = null): complex {
    if (elem != null) {
...
window.onload = () => {
    ...
    let element1:HTMLElement|null = document.getElementById("element1"), coord1: complex = complex(element1);
    let element2:HTMLElement|null = document.getElementById("element2"), coord2: complex = complex(element2);
    let element3:HTMLElement|null = document.getElementById("element3"), coord3: complex = complex(element3);

    //get lines
    let line12:HTMLElement|null = document.getElementById("line12"), func12: line = {m: 0, n: 0};
    let line23:HTMLElement|null = document.getElementById("line23"), func23: line = {m: 0, n: 0};
    ...
    if(element1 != null && element2!=null && element3!= null && line12!= null && line23 != null){
        ...
        let angle : number = Math.atan(func12.m)/2;
